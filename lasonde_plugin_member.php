...
function LSD_plugin_member_init() {
  	...
  	$admin_page = add_menu_page(LSD_PAGE_MEMBER_OPTIONS, LSD_PLUGIN_TITLE, 'administrator', LSD_PAGE_MEMBER_OPTIONS, 'Lasonde_plugin_options', LSD_MEMBER_PLUGIN_IMAGES.'lasonde_icone.gif');
}
...
add_action('widgets_init', create_function('', 'return register_widget("LSD_widget");'));
